...
Its Chic Brasil needs an initial landing page for moda, joias e semi-joias. The brand already exists on Instagram as `@itschicbr`. The available reference is a screenshot of the Instagram profile, showing a pink circular logo, gold jewelry, light product photos, and accessible social-commerce language.
...
- Present Its Chic Brasil as a quality/premium-accessible brand for fashion, jewelry, semi-jewelry, and accessories.
...
The page is aimed at women looking for everyday pieces that make an outfit feel more polished: accessories, semi-jewelry, jewelry, bags, and fashion items. The tone should be warm, direct, feminine, and commercial without feeling cheap or overly promotional.
...
- Warm gold accents for jewelry and highlight details.
...
1. **Header**
   ...
   - Short navigation anchors: Moda, Joias, Semi-joias, Destaques.
   - Instagram handle or CTA link to `@itschicbr`.

2. **Hero**
   - Main headline: a clear promise around elevating the look with moda, joias, and semi-joias.
...
4. **Categories**
   - Cards for Moda, Joias, Semi-joias, and Bolsas/Acessorios.
...
> Moda, joias e semi-joias para elevar seu look
